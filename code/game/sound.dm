	...
	if(istext(sound))
		switch(sound)
			...
			if("alien_footstep_small")
				sound = pick('sound/effects/alien_footstep_small1.ogg','sound/effects/alien_footstep_small2.ogg','sound/effects/alien_footstep_small3.ogg','sound/effects/alien_footstep_small4.ogg')
			if("alien_charge")
