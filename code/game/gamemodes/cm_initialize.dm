...
/datum/game_mode
	...
	//Bioscan related.
	var/bioscan_current_interval = 10 MINUTES//5 minutes in
	var/bioscan_ongoing_interval = 5 MINUTES//every 1 minute
	...
	var/round_time_resin = 10 MINUTES //Time for when resin placing is allowed close to LZs
